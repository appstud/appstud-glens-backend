...
def testFaceDetection(cap):
    ...
    while(True):
        ...
        if(ret):
            ...
            r.publish("object-detection",data)
            print("Sent image to process!")

        try:

            data=json.loads(p.get_message(timeout=0.2)['data'])
            print(data)
...
if(__name__=="__main__"):
    ...
    #cap1=cv2.VideoCapture("vid2.mp4")
    cap1=cv2.VideoCapture(0)
    #cap1=cv2.VideoCapture("./OxfordTownCentre/TownCentreXVID.mp4")
